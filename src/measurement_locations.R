...
print(ggmap(mapdata) + geom_point(aes(x=Longitude, y=Latitude, color="red"), data=wnv))

print(ggmap(mapdata) + geom_point(aes(x=Longitude, y=Latitude), data=spray, colour="red")+ geom_point(aes(x=Longitude, y=Latitude), data=wnv, colour="blue"))
